...
## 📖 Overview
Welcome to the **3d_drawing** repository. This project provides a robust solution for its respective domain, focusing on clean code, maintainability, and scalability. It has been meticulously structured to provide an excellent developer experience.
...
1. Clone the repository to your local machine:
   ```bash
   git clone https://github.com/ytanmay122005/3d_drawing.git
   ```
